...
const Page = () => {
  ...
  const HandleSubmitAddUser = async (
    ...
    const { full_name, role, password, email } = Object.fromEntries(
      new FormData(form)
    );
    await api
      .post("/auth/addUser", {
  ...
  const HandleSubmitAddPartner = async (
    ...
    event.preventDefault();
    const form = event.currentTarget;
    const { user_id, name_compagny, address, city, postcode, phone } =
    ...
    <>
      <div className="c-users o-padding">
        ...
        <Modal
          ...
          isOpen={isOpen}
          name="Enregistrer un utilisateur"
        >
              ...
              <div>
                ...
                <div className="content-input">
                  ...
                  <Input
                    ...
                    type="email"
                    name="email"
                    placeholder="contact@letsgoeurope.fr"
                  />
                </div>
              </div>
              <div>
        ...
        <Modal
          closeModal={closeModalPartenaire}
          isOpen={isOpenPartner}
          name="Enregistrer un partenaire"
        >
            ...
            <div className="container-form">
              <div>
                <div className="content-input">
                  ...
                  >
                    {partner &&
                      partner.map((user: any, index: number) => {
                        return (
