...
const Page = ({ params }: { params: { id: string } }) => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (response.status === 200) {
      ...
      toast.error(
        "Désolé, votre tentative de changement de mot de passe a échoué. Veuillez réessayer plus tard ou contacter notre service d'assistance si le problème persiste",
        { position: toast.POSITION.BOTTOM_CENTER }
      );
    }
  };
