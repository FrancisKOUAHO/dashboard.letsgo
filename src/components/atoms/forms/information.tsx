...
const InformationActivity = ({ onNext }: { onNext: (values: any) => void }) => {
  ...
  return (
    <form
      ...
      className="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400"
    >
      ...
      <div className="mt-5">
          ...
          <label className="inline-block mb-2 sm:mb-0 sm:mr-5 sm:text-right xl:w-64 xl:!mr-10">
            <div className="text-left">
              <div className="flex items-center">
                ...
                <div className="text-red-500 ml-2 px-2 py-0.5 bg-slate-100 text-slate-600 dark:bg-darkmode-300 dark:text-slate-400 text-xs rounded-md">
                  {" "}
                  Obligatoire
                </div>
              </div>
        ...
        <div className="block sm:flex flex-col items-start pt-5 mt-5 xl:flex-row first:mt-0 first:pt-0">
          ...
          <div className="flex-1 w-full mt-3 xl:mt-0">
            ...
            >
              {organisators &&
                organisators.data.map((organisator: any, index: number) => {
                  return (
                    <option key={index} value={organisator.name_compagny}>
                      {organisator.name_compagny}
                    </option>
                  );
                })}
            </select>
          ...
          <div className="flex-1 w-full mt-3 xl:mt-0">
            ...
            >
              {organisators &&
                organisators.data.map((organisator: any, index: number) => {
                  return (
                    <option key={index} value={organisator.id}>
                      {organisator.name_compagny}{" "}
                    </option>
                  );
                })}
...
const ActivitySchedule = ({
  ...
  const handleAddSchedule = (event: any) => {
    ...
    if (!date || !hour) {
      toast(`Veuillez entrer une date et une heure`, {
        ...
        <div className="block sm:flex flex-col items-start pt-2 mt-2 xl:flex-row first:mt-0 first:pt-0">
          ...
          <div className="flex-1 w-full mt-3 xl:mt-0">
            <div className="relative py-10 pl-5 pr-5 rounded-md xl:pr-10 bg-slate-50 dark:bg-transparent dark:border">
              <div>
                <div className="block sm:flex items-center mt-5 first:mt-0">
                  ...
                  <div className="flex items-center flex-1 xl:pr-20">
                    <div className="flex flex-1">
                      <input
                        ...
                        placeholder="Size"
                      />
                      <div className="py-2 px-3 bg-slate-100 border shadow-sm border-slate-200 text-slate-600 dark:bg-darkmode-900/20 dark:border-darkmode-900/20 dark:text-slate-400 rounded-none [&amp;:not(:first-child)]:border-l-transparent first:rounded-l last:rounded-r">
                        1
                      </div>
                    </div>
                  </div>
    ...
    >
      ...
      <div className="mt-5">
        <div className="block sm:flex flex-col items-start mt-10 xl:flex-row">
          <label className="inline-block mb-2 sm:mb-0 sm:mr-5 sm:text-right w-full xl:w-64">
            <div className="text-left">
              <div className="flex items-center">
                <div className="font-medium">Photos du produit</div>
              ...
              <div className="mt-3 text-xs leading-relaxed text-slate-500">
                <div>
                  {" "}
                  {"Le format de l'image est .jpg .jpeg .png et sa taille minimale est de 300 x 300 pixels (pour des images optimales, utilisez une taille minimale de 700 x 700 pixels).\n" +
          ...
          <div className="flex-1 w-full pt-4 mt-3 border-2 border-dashed rounded-md xl:mt-0 dark:border-darkmode-400">
                ...
                {image && (
                  <div>
                    <img
                      ...
                      alt="Uploaded image"
                    />
                    <span className="cursor-pointer absolute top-0 right-0 flex items-center justify-center w-5 h-5 -mt-2 -mr-2 text-white rounded-full bg-danger">
                      <svg
            ...
            <div className="relative flex items-center justify-center px-4 pb-4 mt-5 cursor-pointer">
              ...
              <span className="mr-1 text-primary text-sm">
                {" "}
...
export { DetailsActivity, InformationActivity, ActivitySchedule, UploadImage };
